...
Write-Host "CaseMesh AI - Phase 24 Grounded Answers Setup" -ForegroundColor Cyan
...
if (-not $modelInstalled) {
    ...
    Write-Host "This is a one-time local download and may be several GB." -ForegroundColor DarkGray
...
Write-Host ""
Write-Host "Confirming database migrations..." -ForegroundColor Yellow
Invoke-Native {
...
Write-Host ""
Write-Host "Phase 24 grounded answer setup complete." -ForegroundColor Green
Write-Host ""
...
Write-Host "GET  /generation/health"
Write-Host "POST /cases/{case_id}/answers"
